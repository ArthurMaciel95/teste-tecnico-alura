  ...
  return (
    <section className="flex flex-col items-center mx-auto max-w-[675px] w-full text-center justify-center mt-20">
      ...
      <Slide direction="up" duration={800} delay={800} triggerOnce>
        <h1 className="lg:text-6xl text-brand-blue-600 chakra-petch font-bold leading-[1.1] text-5xl">
          Eu ensino{" "}
      ...
      <Fade duration={600} delay={1200} triggerOnce>
        <p className="text-center max-w-[587px] px-4 lg:px-0 text-base text-brand-blue-300 font-normal mt-6">
